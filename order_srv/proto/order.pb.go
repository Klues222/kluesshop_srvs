...
var file_order_proto_rawDesc = []byte{
	...
	0x6d, 0x73, 0x22, 0xc9, 0x01, 0x0a, 0x11, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x74, 0x65, 0x6d,
	...
	0x67, 0x6f, 0x6f, 0x64, 0x73, 0x22, 0x51, 0x0a, 0x11, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4c, 0x69,
	...
	0x73, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x91, 0x02, 0x0a, 0x11, 0x4f, 0x72, 0x64,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xc3,
	0x03, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x2c, 0x0a, 0x08, 0x43, 0x61, 0x72, 0x74,
	0x49, 0x74, 0x65, 0x6d, 0x12, 0x09, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x1a,
	...
	0x6d, 0x70, 0x74, 0x79, 0x42, 0x09, 0x5a, 0x07, 0x2f, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
...
var file_order_proto_depIdxs = []int32{
	...
	0,  // 4: Order.CartItem:input_type -> UserInfo
	...
	10, // 12: Order.CartItem:output_type -> CartItemListResponse
	...
	6,  // 18: Order.OrderDetail:output_type -> OrderInfoDetailResponse
...
type OrderClient interface {
	//购物车
	CartItem(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*CartItemListResponse, error)
...
func (c *orderClient) CartItem(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*CartItemListResponse, error) {
	out := new(CartItemListResponse)
	err := c.cc.Invoke(ctx, "/Order/CartItem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	//购物车
	CartItem(context.Context, *UserInfo) (*CartItemListResponse, error)
...
func (*UnimplementedOrderServer) CartItem(context.Context, *UserInfo) (*CartItemListResponse, error) {
...
func _Order_CartItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).CartItem(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Order/CartItem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).CartItem(ctx, req.(*UserInfo))
	}
...
var _Order_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CartItem",
			Handler:    _Order_CartItem_Handler,
		},
		{
