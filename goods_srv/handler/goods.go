...
// func (g *GoodsServer)DeleteGoods(context.Context, *proto.DeleteGoodsInfo) (*proto.emptypb.Empty, error){}
// func (g *GoodsServer)UpdateGoods(context.Context, *proto.CreateGoodsInfo) (*proto.emptypb.Empty, error){}
